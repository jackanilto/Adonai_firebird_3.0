...
type
  TDM = class(TDataModule)
    ...
    RelCarteira1: TfrxReport;
    RelDScarteira: TfrxDBDataset;
    RelDSigrejas: TfrxDBDataset;
    RelDSDOC: TfrxDBDataset;
    CertificadoBatismo2: TfrxReport;
    CertificadoBatismo1: TfrxReport;
    ...
    QueryTratamentosID: TIntegerField;
    QueryTratamentosTRATAMENTO: TStringField;
    QueryIgrejasID: TIntegerField;
    QueryIgrejasNOME_IGREJA: TStringField;
    QueryIgrejasLOGO_CARTEIRAS: TStringField;
    QueryIgrejasPASTOR_PRES: TStringField;
    QueryIgrejasPASTOR_DIRIG: TStringField;
    QueryIgrejasSITE: TStringField;
    QueryIgrejasEMAIL: TStringField;
    QueryIgrejasCONTATO: TStringField;
    QueryIgrejasLOGO_CARTAS: TStringField;
    TBL_IGREJASID: TIntegerField;
    TBL_IGREJASNOME_IGREJA: TStringField;
    TBL_IGREJASLOGO_CARTEIRAS: TStringField;
    TBL_IGREJASPASTOR_PRES: TStringField;
    TBL_IGREJASPASTOR_DIRIG: TStringField;
    TBL_IGREJASSITE: TStringField;
    TBL_IGREJASEMAIL: TStringField;
    TBL_IGREJASCONTATO: TStringField;
    TBL_IGREJASLOGO_CARTAS: TStringField;
    TBL_IGREJASENDERECO: TStringField;
    TBL_IGREJASCNPJ: TStringField;
    QueryIgrejasCNPJ: TStringField;
    QueryIgrejasENDERECO: TStringField;
    CDSCarteiraMINISTERIO: TStringField;
    CDSCarteiraDATA_NASC: TDateField;
    RelCarteira2: TfrxReport;
    CartaRecomendacao: TfrxReport;
    CartaApresentacao: TfrxReport;
    RelCarteira3: TfrxReport;
    AniverCasamento: TfrxReport;
    Transferencia: TfrxReport;
    CertificadoBatismo3: TfrxReport;
    CertificadoBatismo4: TfrxReport;
    CertificadoBatismo5: TfrxReport;
    CertificadoBatismo6: TfrxReport;
