inherited FrmDocumentos: TFrmDocumentos
  ...
  ExplicitHeight = 637
  TextHeight = 13
  inherited btnCarteirinha: TSpeedButton
    Left = 20
    Top = 471
    ExplicitLeft = 20
    ExplicitTop = 471
  end
  object btnCartaRecomenda: TSpeedButton [4]
    Left = 203
    Top = 471
    Width = 177
    Height = 49
    Caption = 'Carta de Recomenda'#231#227'o'
    Glyph.Data = {
    ...
    OnClick = btnCartaRecomendaClick
  end
  object btnLimpaListaDocumentos: TSpeedButton [6]
    Left = 744
    Top = 471
    Width = 177
    Height = 49
  ...
  object btnCertificaBatismo: TSpeedButton [7]
    Left = 386
    Top = 471
    Width = 177
    Height = 49
    ...
    Glyph.Data = {
      ...
      FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
      FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
    OnClick = btnCertificaBatismoClick
  end
  object btnAniverCasamento: TSpeedButton [8]
    Left = 20
    Top = 526
    Width = 177
    Height = 49
    Caption = 'Aniversario de Casamento'
    Glyph.Data = {
      F6060000424DF606000000000000360000002800000018000000180000000100
      180000000000C006000000000000000000000000000000000000043988043988
      0439880439890438890439890439880539880439890439880539880439890539
      ...
      FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
      FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
    OnClick = btnAniverCasamentoClick
  end
  object btnCertificaBatismo2: TSpeedButton [9]
    Left = 386
    Top = 526
    Width = 177
    Height = 49
    Caption = 'Certificado de Batismo 2'
    Glyph.Data = {
      F6060000424DF606000000000000360000002800000018000000180000000100
      180000000000C006000000000000000000000000000000000000043988043988
      0439880439890438890439890439880539880439890439880539880439890539
      ...
      FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
      FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF}
    OnClick = btnCertificaBatismo2Click
  end
