...
type
  TFrmCartMembro4 = class(TForm)
    FrmRelCarteira4: TRLReport;
    RLBand1: TRLBand;
    RLLabel1: TRLLabel;
...
var
  FrmCartMembro4: TFrmCartMembro4;
  caminhoImg: string;
...
procedure TFrmCartMembro4.CarregarImagemNoTImage(DiretorioImagem: string;
  AImage: TImage);
var
  Imagem: TPngImage;
  Bitmap: TBitmap;
...
procedure TFrmCartMembro4.RLBand2BeforePrint(Sender: TObject; var PrintIt: Boolean);
var
